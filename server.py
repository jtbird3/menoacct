...
PROP_URLS = {1: '/i1', 2: '/i2', 3: '/i3', 4: '/i4', 5: '/i5', 6: '/i6', 7: '/i7', 8: '/i8', 9: '/i9', 10: '/i10', 11: '/i11', 12: '/i12', 13: '/i13', 14: '/i14', 15: '/i15'}
TOTAL_PROPS = 48
...
@app.get('/i15', response_class=HTMLResponse)
async def i15(request: Request):
    gate = prop_gate(request)
    return gate or FileResponse('static/i15.html')
